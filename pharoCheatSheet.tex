...
\begin{tabularx}{\linewidth}{@{}rX@{}}
        ...
        \code{exp.} & expression separator (period)\\
        \code{;} & message cascade (semicolon)\\
        \code{var := expr} & {assignment} \\
        \code{\textasciicircum expr} & return a result from a method (caret)\\
...
\code{new} is an unary message sent to classes. 
...
the argument. The string \textcolor{string}{\code{'Hello'}} receives the message \code{,}
...
\begin{center}
  \includegraphics[width=0.8\textwidth]{nautilus-anotated}
\end{center}
