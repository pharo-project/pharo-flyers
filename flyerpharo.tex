...
>>>>>>> variant B
Pharo is both an \emph{object-oriented}, \emph{dynamically-typed} language
and its own programming environment. The language has a simple and very expressive syntax which
can be learned in just a few minutes. In Pharo, the concepts are
